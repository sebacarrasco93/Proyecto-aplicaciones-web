    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <select id="tiposolicitud" name="tiposolicitud" class="form-select" required>
                <option selected value="{{ old('tiposolicitud') }} @isset($formulario) {{ $formulario->tiposolicitud }} @endisset">{{ old('tiposolicitud') }} @isset($formulario) {{ $formulario->tiposolicitud }} @endisset</option>
    ...
    <div class="row">
            ...
            <div class="form-group espaciado">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="user_name" name="user_name" placeholder="Nombre"
                           value="{{ old('user_name') }} @isset($formulario) {{ $formulario->user_name }} @endisset" required />
                    <div class="invalid-feedback">
                    ...
                    <div class="col-md">
                        <div class="form-floating espaciado">
                            <input type="text" class="form-control" id="apellidopaterno" name="apellidopaterno" placeholder="Apellido Paterno"
                                   value="{{ old('apellidopaterno') }} @isset($formulario) {{ $formulario->apellidopaterno }} @endisset" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="apellidomaterno" name="apellidomaterno" placeholder="Apellido Materno"
                                   value="{{ old('apellidomaterno') }} @isset($formulario) {{ $formulario->apellidomaterno }} @endisset" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md">
                        <div class="form-floating espaciado">
                            <input type="text" class="form-control" id="user_dni" name="user_dni" placeholder="Rut"
                                   value="{{ old('user_dni') }} @isset($formulario) {{ $formulario->user_dni }} @endisset" required onblur="validarRut()">
                            <div class="invalid-feedback">
                                Ingrese Rut
                            </div>
                    ...
                    <div class="col-md">
                        <div class="form-floating espaciado">
                            <input type="text" class="form-control" id="nacionalidad" name="nacionalidad" placeholder="Nacionalidad"
                                   value="{{ old('nacionalidad') }} @isset($formulario) {{ $formulario->nacionalidad }} @endisset" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md">
                        <div class="form-floating espaciado">
                            <input type="date" class="form-control" id="fechanacimiento" name="fechanacimiento" placeholder="Fecha de Nacimiento"
                                   value="{{ old('fechanacimiento') }} @isset($formulario) {{ $formulario->fechanacimiento }} @endisset" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md">
                        <div class="form-floating espaciado">
                            <select id="sexo" name="sexo" class="form-select" required>
                                <option selected value="{{ old('sexo') }} @isset($formulario) {{ $formulario->sexo }} @endisset">{{ old('sexo') }} @isset($formulario) {{ $formulario->sexo }} @endisset</option>
        ...
        <div class="col-md-8 offset-md-2">
            ...
            <div class="row g-2">
                <div class="col-md">
                    <div class="form-floating espaciado">
                        <input type="text" class="form-control" id="user_address" name="user_address" placeholder="Direccion"
                               value="{{ old('user_address') }} @isset($formulario) {{ $formulario->user_address }} @endisset" required onclick="UserAddress()" {{-- onblur="leftUser()" --}}>
                        <div class="invalid-feedback">
                ...
                <div class="col-md">
                    <div class="form-floating espaciado">
                        <input type="text" class="form-control" id="ciudad" name="ciudad" placeholder="Ciudad"
                               value="{{ old('ciudad') }} @isset($formulario) {{ $formulario->ciudad }} @endisset" required onblur="leftUser()">
                        <div class="invalid-feedback">
                ...
                <div class="col-md">
                    <div class="form-floating espaciado">
                        <input type="text" class="form-control" id="comuna" name="comuna" placeholder="Comuna"
                               value="{{ old('comuna') }} @isset($formulario) {{ $formulario->comuna }} @endisset" required onblur="leftUser()">
                        <div class="invalid-feedback">
                ...
                <div class="col-md">
                    <div class="form-floating espaciado">
                        <select class="form-select" id="region" name="region" required>
                            <option selected value="{{ old('region') }} @isset($formulario) {{ $formulario->region }} @endisset">{{ old('region') }} @isset($formulario) {{ $formulario->region }} @endisset</option>
                            <option disabled value="">Opciones Disponibles Para Cambio</option>
                ...
                <div class="col-md">
                    <div class="form-floating espaciado">
                        <select id="tipodepropiedad" name="tipodepropiedad" class="form-select" required>
                            <option selected value="{{ old('tipodepropiedad') }} @isset($formulario) {{ $formulario->tipodepropiedad }} @endisset">{{ old('tipodepropiedad') }} @isset($formulario) {{ $formulario->tipodepropiedad }} @endisset</option>
                            <option disabled value="">Opciones Disponibles Para Cambio</option>
                ...
                <div class="col-md">
                    <div class="form-floating espaciado">
                        <input type="text" class="form-control" id="email" name="email" placeholder="Email"
                               value="{{ old('email') }} @isset($formulario) {{ $formulario->email }} @endisset" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md">
                    <div class="form-floating espaciado">
                        <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Telefono"
                               value="{{ old('telefono') }} @isset($formulario) {{ $formulario->telefono }} @endisset" required>
                        <div class="invalid-feedback">
            ...
            <div class="form-group espaciado">
                <div class="input-group espaciado">
                    <select id="tipoasegurado" name="tipoasegurado" class="form-select" onchange="verPension()" required>
                        <option selected value="{{ old('tipoasegurado') }} @isset($formulario) {{ $formulario->tipoasegurado }} @endisset">{{ old('tipoasegurado') }} @isset($formulario) {{ $formulario->tipoasegurado }} @endisset</option>
                ...
                <fieldset hidden id=selectCesantia>
                    <div class="input-group espaciado">
                        <select id="tipoCesantia" name="tipoCesantia" class="form-select">
                            <option selected value="{{ old('tipoCesantia') }} @isset($formulario) {{ $formulario->tipoCesantia }} @endisset">{{ old('tipoCesantia') }} @isset($formulario) {{ $formulario->tipoCesantia }} @endisset</option>
                ...
                <fieldset hidden id=selectPension>
                    <div class="input-group espaciado">
                        <select id="pensionado" name="pensionado" class="form-select">
                            <option selected value="{{ old('pensionado') }} @isset($formulario) {{ $formulario->pensionado }} @endisset">{{ old('pensionado') }} @isset($formulario) {{ $formulario->pensionado }} @endisset</option>
                            <option disabled value="">Opciones Disponibles para Cambio</option>
                            </option>
            ...
            <fieldset hidden id=pensionSi>
                ...
                <div class="input-group espaciado">
                    <select id="pagadorapension" name="pagadorapension" class="form-select">
                        <option selected value="{{ old('pagadorapension') }} @isset($formulario) {{ $formulario->pagadorapension }} @endisset">{{ old('pagadorapension') }} @isset($formulario) {{ $formulario->pagadorapension }} @endisset</option>
                        <option disabled value="">Opciones Disponibles para cambio</option>
