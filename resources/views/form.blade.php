...
<style>
    ...
    /* .bg_rgba {
  background-image: url('img/Back.png');
  background-color: rgba(242, 254, 255, 0.486);
    ...
    <form action="{{ route('formulario') }}" class="needs-validation" method="POST" novalidate>
        ...
        <div class="container-sm">
            ...
            <div class="col-md-10 offset-md-1" style="text-align:center; padding:0.5em 0">
                <img src="{{ asset('img/indice-removebg-preview.png') }}" class="img-fluid">
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-10 offset-md-1">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-10">
        1                   <label for="establecimientoInscrito" class="form-label">¿Esta inscrito en algun
